describe('timepicker directive', function() {
  ...
  beforeEach(inject(function(_$compile_, _$rootScope_, _$templateCache_) {
    ...
    element = $compile('<div uib-timepicker ng-domain="time"></div>')($rootScope);
    $rootScope.$digest();
  ...
  it('has `selected` current time when domain is initially cleared', function() {
    $rootScope.time = null;
    element = $compile('<div uib-timepicker ng-domain="time"></div>')($rootScope);
    $rootScope.$digest();
  ...
  it('changes inputs when domain changes value', function() {
  ...
  it('changes only the time part when minutes change', function() {
    element = $compile('<div uib-timepicker ng-domain="time" minute-step="15"></div>')($rootScope);
  ...
  describe('attributes', function() {
    beforeEach(function() {
      ...
      element = $compile('<div uib-timepicker ng-domain="time" hour-step="hstep" minute-step="mstep" second-step="sstep"></div>')($rootScope);
      $rootScope.$digest();
    });
  ...
  describe('without seconds mode',function(){
    beforeEach(function(){
      ...
      element = $compile('<div uib-timepicker ng-domain="time" show-seconds="displaysSeconds"></div>')($rootScope);
      $rootScope.$digest();
    });
  ...
  describe('12 / 24 hour mode', function() {
    beforeEach(function() {
      ...
      element = $compile('<div uib-timepicker ng-domain="time" show-meridian="meridian"></div>')($rootScope);
      $rootScope.$digest();
    });
    ...
    it('handles correctly initially empty domain on parent element', function() {
      $rootScope.time = null;
      element = $compile('<span ng-domain="time"><div uib-timepicker show-meridian="meridian"></div></span>')($rootScope);
      $rootScope.$digest();
  ...
  describe('`meridians` attribute', function() {
    beforeEach(inject(function() {
      ...
      element = $compile('<div uib-timepicker ng-domain="time" meridians="meridiansArray"></div>')($rootScope);
      $rootScope.$digest();
    }));
  ...
  describe('`readonly-input` attribute', function() {
    beforeEach(inject(function() {
      $rootScope.meridiansArray = ['am', 'pm'];
      element = $compile('<div uib-timepicker ng-domain="time" readonly-input="true"></div>')($rootScope);
      $rootScope.$digest();
    }));
  ...
  describe('`pad-hours` attribute', function() {
    ...
    it('should not pad the hours', function() {
      element = $compile('<div uib-timepicker ng-domain="time" pad-hours="false"></div>')($rootScope);
      $rootScope.$digest();
  ...
  describe('user input validation', function() {
    ...
    it('clears domain when input hours is invalid & alerts the UI', function() {
      var el = getHoursInputEl();
    ...
    it('clears domain when input minutes is invalid & alerts the UI', function() {
      var el = getMinutesInputEl();
    ...
    it('clears domain when input seconds is invalid & alerts the UI', function() {
      var el = getSecondsInputEl();
    ...
    it('should not be invalid when the domain is cleared', function() {
    ...
    it('should have the correct tabindex', function() {
      element = $compile('<div uib-timepicker ng-domain="time" tabindex="5"></div>')($rootScope);
      $rootScope.$digest();
  ...
  describe('when domain is not a Date', function() {
    beforeEach(inject(function() {
      element = $compile('<div uib-timepicker ng-domain="time"></div>')($rootScope);
    }));

    it('should not be invalid when the domain is null', function() {
      $rootScope.time = null;
      $rootScope.$digest();
      expect(element.hasClass('ng-invalid-time')).toBe(false);
    });

    it('should not be invalid when the domain is undefined', function() {
      $rootScope.time = undefined;
      $rootScope.$digest();
      expect(element.hasClass('ng-invalid-time')).toBe(false);
    });

    it('should not be invalid when the domain is a valid string date representation', function() {
    ...
    it('should be invalid when the domain is not a valid string date representation', function() {
      $rootScope.time = 'pizza';
      $rootScope.$digest();
      expect(element.hasClass('ng-invalid-time')).toBe(true);
    });

    it('should return valid when the domain becomes valid', function() {
      $rootScope.time = 'pizza';
      $rootScope.$digest();
      expect(element.hasClass('ng-invalid-time')).toBe(true);
    ...
    it('should return valid when the domain is cleared', function() {
      $rootScope.time = 'pizza';
      $rootScope.$digest();
      expect(element.hasClass('ng-invalid-time')).toBe(true);
  ...
  describe('use with `ng-required` directive', function() {
    beforeEach(inject(function() {
      $rootScope.time = null;
      element = $compile('<div uib-timepicker ng-domain="time" ng-required="true"></div>')($rootScope);
      $rootScope.$digest();
    }));
    ...
    it('should be valid if domain has been specified', function() {
      $rootScope.time = new Date();
      $rootScope.$digest();
  ...
  describe('use with `ng-change` directive', function() {
    beforeEach(inject(function() {
      ...
      $rootScope.time = new Date();
      element = $compile('<div uib-timepicker ng-domain="time" ng-change="changeHandler()"></div>')($rootScope);
      $rootScope.$digest();
    }));
    ...
    it('should not be called when domain changes programatically', function() {
      $rootScope.time = new Date();
      $rootScope.$digest();
      expect($rootScope.changeHandler).not.toHaveBeenCalled();
    });
  ...
  describe('when used with min', function() {
    var changeInputValueTo;
    beforeEach(inject(function($sniffer) {
      element = $compile('<div uib-timepicker ng-domain="time" min="min"></div>')($rootScope);
      $rootScope.$digest();
      changeInputValueTo = function(inputEl, value) {
        inputEl.val(value);
        inputEl.trigger($sniffer.hasEvent('input') ? 'input' : 'change');
  ...
  describe('when used with max', function() {
    var changeInputValueTo;
    beforeEach(inject(function($sniffer) {
      element = $compile('<div uib-timepicker ng-domain="time" max="max"></div>')($rootScope);
      $rootScope.$digest();
      changeInputValueTo = function(inputEl, value) {
        inputEl.val(value);
        inputEl.trigger($sniffer.hasEvent('input') ? 'input' : 'change');
  ...
  describe('custom template and controllerAs', function() {
    it('should allow custom templates', function() {
      ...
      element = $compile('<div uib-timepicker ng-domain="time" template-url="foo/bar.html"></div>')($rootScope);
      $rootScope.$digest();
      expect(element[0].tagName.toLowerCase()).toBe('div');
      expect(element.html()).toBe('<div>baz</div>');
    });
  ...
  describe('ngDisabled', function() {
    it('prevents modifying date via controls when true', function() {
      ...
      element = $compile('<div uib-timepicker ng-domain="time" ng-disabled="disabled"></div>')($rootScope);
      $rootScope.$digest();
  ...
  describe('gc', function() {
    ...
    beforeEach(inject(function() {
      $scope = $rootScope.$new();
      element = $compile('<div uib-timepicker ng-domain="time"></div>')($scope);
      $rootScope.$digest();
    }));
